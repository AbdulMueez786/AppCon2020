...
public class GroupChatAdapter extends RecyclerView.Adapter<GroupChatAdapter.ViewHolder> {
    ...
    public GroupChatAdapter(Context c , List<GroupChat> ls, String image_url){
        this.c=c;
        this.ls=ls;
    ...
    @Override
    public void onBindViewHolder(@NonNull final GroupChatAdapter.ViewHolder holder, int position) {


        final GroupChat chat=ls.get(position);
